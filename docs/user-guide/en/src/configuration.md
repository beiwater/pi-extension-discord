...
Cache schema 19 automatically starts a new context epoch and preserves old session files; no manual database changes are needed. Mentions, including caption mentions, take precedence over replies across all bots, regardless of bot ordering.
